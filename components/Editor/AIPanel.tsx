  ...
  return (
    <div className="flex-1 h-full flex flex-col bg-[#0a0a0a]">
      <div className="p-4 border-b border-neutral-800 flex items-center justify-between bg-neutral-900/20">
        ...
        <div className="px-1.5 py-0.5 bg-purple-500/10 text-purple-500 rounded text-[8px] font-bold uppercase border border-purple-500/20">
          Powered by Gemini
        </div>
      </div>
        ...
        <div className="pt-4 border-t border-neutral-800/50">
          ...
          <div className="space-y-3">
            {suggestions.map((s) => (
              <div
                key={s.id}
                className="p-3 bg-neutral-900/50 rounded-lg border border-neutral-800 hover:border-neutral-700 transition-all cursor-pointer group"
              >
