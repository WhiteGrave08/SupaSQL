  ...
  return (
    <div className="flex-1 h-full flex flex-col bg-[#0a0a0a]">
            ...
            {sessionLogs.map((log) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div
                    className={`mt-1 w-2 h-2 rounded-full shrink-0 ${log.action.includes("ADD")
      ...
      <div className="p-4 border-t border-neutral-800 bg-neutral-900/20">
        <button
          onClick={() => useStore.getState().setView("logs")}
          className="w-full py-2 bg-neutral-800 hover:bg-neutral-700 text-neutral-300 rounded-lg text-xs font-bold transition-all border border-neutral-700 flex items-center justify-center gap-2"
        >
